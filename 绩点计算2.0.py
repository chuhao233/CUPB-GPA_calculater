...
import xlrd
#打开excel文件
data = xlrd.open_workbook(r"e:\文档\python练手启动！\python趣味进阶课\1.xlsx")
#获取工作表列表-sheets
...
table = tableList[0]
#课程列表
num_list = table.col_values(1)

course_num = len(num_list) - 2
print(course_num)

#课程数量
course_list = num_list[2:course_num+2]

#课程成绩
course_grade = table.col_values(2)[2:course_num+2]
#课程学分
course_point = table.col_values(3)[2:course_num+2]
